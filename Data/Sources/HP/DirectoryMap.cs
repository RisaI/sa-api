...
namespace SAApi.Data.Sources.HP
{
    public class DirectoryMap
    {
        ...
        public string MapFile => Path.Combine(Root, MapFileName);
        public bool HasConfigFile => OmittedFiles.Contains(ConfigFileName);
        public string ConfigFile => Path.Combine(Root, ConfigFileName);
        public IEnumerable<string> ZipFiles { get { return Zips.Keys; } }
